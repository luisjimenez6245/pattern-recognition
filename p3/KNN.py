...
class KNN:
    ...
    def clasificar( self, k ):
        ...
        if( k == 1):
            ...
            for i in rangoK:
                ...
                if repeticion:
                    [existe,ind] = self.buscar_ele( self.muestras[indice][0], repeticion)
                    if existe:
                        repeticion[ind][1] += 1
                    else:
    ...
    def distancia_minima( self, k ):
        ...
        for i in rangoK:
            ...
            if repeticion:
                ...
                if existe:
                    ...
                    repeticion.append( [ self.muestras[indice][0], 1 ,self.muestras[indice][2] ] )
            else:
                repeticion.append( [ self.muestras[indice][0], 1 ,self.muestras[indice][2] ] )
        ...
        for r in repeticion:
            x = r[2][0] / r[1]
            y = r[2][1] / r[1]
            dis = math.sqrt( ( (self.elemento[0] - x)**2 ) + ( (self.elemento[1] - y)**2 ) )
